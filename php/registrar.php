...
<html>
		   		...
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner desc">
		   					<h1 class="heading-section">Registrar.</h1>
		   					<h3 class="fh5co-lead">Selecione o local no mapa e preencha as informações.</h3>
		   				</div>
		   			</div>
		   		</div>
		   	</li>
  ...
  <div id="map" height="460px" width="100%"></div>
    <div id="teste" style="display:none">
      <div id="form">
      <table>           
      <tr><td>O que aconteceu?</td> <td>
             <select id='evento'> +
                  <option value='Assalto a mão armada' SELECTED>Assalto a mão armada</option>
  ...
  <div id="teste2" style="display:none">
    ...
    <form action="ocorrencias.php">
      <br><input type='submit' value='Visualizar mapa'/>
    </form>         
    </div>   
    </div> 
    <script>
      ...
      function initMap() {
        var poa = {lat: -30.031399, lng: -51.224760};
      ...
      function saveData() {
        ...
        var evento = escape(document.getElementById('evento').value);
        var periodo = escape(document.getElementById('periodo').value);
        var dt = escape(document.getElementById('data').value);                 
        var latlng = marker.getPosition();
        var url = 'phpsqlinfo_addrow.php?evento=' + evento + '&periodo=' + periodo +
                  '&data=' + dt + '&lat=' + latlng.lat() + '&lng=' + latlng.lng();
    ...
    <script async defer
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD6BH7LlmFWGtEd5ZsZcujsJPcNAGBaYWE&callback=initMap">
    </script>
