				...
				<div class="row">
					...
					<div class="col-xs-10 text-right menu-1">
						<ul>
							...
							<li class="active"><a href="contact.html">Ocorrências</a></li>
		   		...
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner desc">
		   					<h1 class="heading-section">Ocorrências.</h1>
		   					<h3 class="fh5co-lead">Visualize as ocorrências já registradas.</h3>
		   				</div>
		   			</div>
		   		</div>
		   	</li>
    ...
    <script>
      ...
      //};
        ...
        var map = new google.maps.Map(document.getElementById('map'), {
          center: new google.maps.LatLng(-30.031399, -51.224760),
          zoom: 15
        });
        var infoWindow = new google.maps.InfoWindow;

          // Change this depending on the name of your PHP or XML file
          downloadUrl('http://localhost/Isafety - desatualizado - sem erros/Segurança Colaborativa/isafety/createxml.php', function(data) {
            var xml = data.responseXML;
            var markers = xml.documentElement.getElementsByTagName('marker');
            Array.prototype.forEach.call(markers, function(markerElem) {
              var idmarker = markerElem.getAttribute('idmarker');
              var evento = markerElem.getAttribute('evento');
              var periodo = markerElem.getAttribute('periodo'); 
              var dt = markerElem.getAttribute('dt');             
              ...
              strong.textContent = evento
              infowincontent.appendChild(strong);
              infowincontent.appendChild(document.createElement('br'));

              var text = document.createElement('text');
              text.textContent = "Dia: " + dt + "\r\nPeríodo: " + periodo;
